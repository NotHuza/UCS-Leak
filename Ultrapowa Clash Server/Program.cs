...
namespace UCS
{
    internal class Program
    {
        ...
        internal static string Title = $"Ultrapowa Clash Server v{Constants.Version} Mod B1 - ©Ultrapowa & FJG | Online Players: ";
        ...
        internal static void Main()
        {
            ...
            Logger.WriteCenter("|         FJG Not affiliated to \"Supercell, Oy\".    |");
            Logger.WriteCenter("|        This program is copyrighted worldwide.         |");
            Logger.WriteCenter("|         Modified by FJG FOR new stuf    |");
            Console.ForegroundColor = ConsoleColor.Blue;
            Logger.WriteCenter("+-------------------------------------------------------+");
            Console.ResetColor();
